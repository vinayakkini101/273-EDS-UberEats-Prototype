            ...
            <div className="row vh-100 align-items-center justify-content-center">
                <div className="col card" style={{width: '30rem', height: '55rem'}}>
                    <div className="card-body">
                        ...
                        <form method="POST" action="/RestaurantSignUp">
                            <div  className="mb-3">
                            ...
                            <div  className="mb-3">
                                ...
                                <input type="tel" name="contactno" className="form-control" id="contactno" placeholder="Contact No." pattern="[0-9]{10,10}"  required title="Contact Number having 10 digits" />
                            </div>
                            <div  className="mb-3">
                                <label htmlFor="description">Description</label>
                                <input type="text" name="description" className="form-control" id="description" placeholder="Description" required />
                            </div>
                            <div  className="mb-3">
                                <label htmlFor="starttime">Start Time</label>
                                <input type="time" name="starttime" className="form-control" id="starttime" placeholder="Start Time" required />
                            </div>
                            <div  className="mb-3">
                                <label htmlFor="endtime">End Time</label>
                                <input type="time" name="endtime" className="form-control" id="endtime" placeholder="End Time" required />
                            </div>
                            <div  className="mb-3">
                            ...
                            <div  className="mb-3">
                                ...
                                <input type="password" name="password" className="form-control" id="password" placeholder="Password" required minLength={6} maxLength={12} />
                            </div>
